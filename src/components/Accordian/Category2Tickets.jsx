...
const Category2Tickets = () => {
  return (
    <>
    {/* <h3 className="text-xl p-2 mt-3">Tickets</h3> */}
    <div className="w-[800px] bg-[#f6f6fc] p-10 ">
      {  Jobs["Category2_Ticket"].map((ticket, index) =>
          <div key={`Category2-${index}`} className="shadow-slate-700 rounded-lg mt-3 flex flex-col p-2 gap-3 bg-white">
            <h3>{ticket.title}</h3>
            <p>{ticket.desc}</p>
...
export default Category2Tickets
